                                                              ...
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  (userDetails['show_ride_later_feature'] ==
                                                                              true &&
                                                                          ((widget.type == null)
                                                                              ? etaDetails[choosenVehicle]['enable_bidding'] == false
                                                                              : true))
                                                                      ? InkWell(
                                                                          onTap:
                                                                              () async {
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          InkWell(
                                                                            onTap:
                                                                                () {
                                                                              if ((updateAmount.text.isNotEmpty && double.parse(updateAmount.text.toString()) > double.parse(rideList['price'].toString()))) {
                                                                                setState(() {
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              alignment: Alignment.center,
                                                                              decoration: BoxDecoration(
                                                                                  color: (updateAmount.text.isNotEmpty && double.parse(updateAmount.text.toString()) > double.parse(rideList['price'].toString()))
                                                                                      ? (isDarkTheme)
                                                                                          ? Colors.white
                                                                                          : Colors.black
                                                                                      : borderLines,
                                                                          ...
                                                                          InkWell(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              width: media.width * 0.2,
                                                                              alignment: Alignment.center,
                                                                              decoration: BoxDecoration(color: (isDarkTheme) ? Colors.white : Colors.black, borderRadius: BorderRadius.circular(media.width * 0.04)),
                                                                              padding: EdgeInsets.all(media.width * 0.025),
                                                                              child: Text(
                                                                                '+10',
                                                                                style: GoogleFonts.notoSans(fontSize: media.width * fourteen, fontWeight: FontWeight.w600, color: (isDarkTheme) ? Colors.black : Colors.white),
                                                                              ...
                                                                              text: (userRequestData['accepted_at'] != null && userRequestData['arrived_at'] == null && _dist != null)
                                                                                  ...
                                                                                  : (userRequestData['accepted_at'] != null && userRequestData['arrived_at'] != null && userRequestData['is_trip_start'] == 0)
                                                                                      ...
                                                                                      : (userRequestData['accepted_at'] != null && userRequestData['arrived_at'] != null && userRequestData['is_trip_start'] != null)
                                                                                          ? (userRequestData['transport_type'] == 'taxi' && _dist != null)
                                                                                              ? (userRequestData['drop_address'] == null)
