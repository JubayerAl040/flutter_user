        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              padding: EdgeInsets.all(media.width * 0.05),
              child: (rideLaterSuccess)
                  ? Column(
                      children: [
                        Text(
                          languages[choosenLanguage]['text_rideLaterSuccess'],
                  ...
                  : (widget.type != 1)
                      ? Column(
                          ...
                          children: [
                            ...
                            Button(
                              onTap: () async {
                                if (widget.isOneWayTrip == true &&
                                    yourAmount.text.isNotEmpty &&
...
class ChoosePaymentMethodContainer extends StatefulWidget {
  final dynamic type;
  const ChoosePaymentMethodContainer({super.key, this.type});
